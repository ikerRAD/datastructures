...
public class LinkedBinarySearchTree<T> extends LinkedBinaryTree<T> implements BinarySearchTreeADT<T> {
	 ...
	 * a reference to its element. Throws an EmptyBinarySearchTreeException if this
	 * tree is empty.
	 *
	 ...
	 * returns a reference to its element. Throws an EmptyBinarySearchTreeException
	...
	public T find(T targetElement) throws ElementNotFoundException {
		...
		if (!(current.getElement().equals(targetElement)) && (current.getLeft() != null)
				&& (((Comparable<T>) current.getElement()).compareTo(targetElement) > 0))
	...
	private BinaryTreeNode<T> findAgain(T targetElement, BinaryTreeNode<T> next) {
		...
		if (!(next.getElement().equals(targetElement)) && (next.getLeft() != null)
				&& (((Comparable<T>) next.getElement()).compareTo(targetElement) > 0))
